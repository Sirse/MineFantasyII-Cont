...
public class ConfigStamina extends ConfigurationBaseMF {
    ...
    protected void loadConfig() {
        StaminaBar.isSystemActive = Boolean.parseBoolean(
                config.get(
        ...
        StaminaBar.pauseModifier = Float.parseFloat(
                config.get(VALUES, "Idle Modifier", 1.0F, "This modifies the time between decaying and regenning back")
                        .getString());
        StaminaBar.configBulk = Float.parseFloat(
                config.get(
                        VALUES,
                        "Bulk Regen Modifier",
                        1.0F,
                        ...
                        .getString());
        StaminaBar.scaleDifficulty = Boolean.parseBoolean(
                config.get(
                        VALUES,
                        ...
                        .getString());
        StaminaBar.defaultMax = Float.parseFloat(
                config.get(
                        VALUES,
                        "Max stamina base",
                        100F,
        ...
        fullRegenSeconds = Integer.parseInt(
                config.get(
                        VALUES,
                        "Regen Time",
                        15,
        ...
        StaminaBar.configArmourWeightModifier = Float.parseFloat(
                config.get(VALUES, "Weight Modifier", 1.0F, "Modifies the amount weight of armour slows decay")
                        .getString());
        miningSpeed = Float.parseFloat(
                config.get(VALUES, "Mining Modifier", 1.0F, "Modifies the rate block breaking drains stamina")
                        .getString());
        exhaustDamage = Float.parseFloat(
                config.get(
                        VALUES,
                        "Exhausted Damage Modifier",
                        1.5F,
        ...
        affectMining = Boolean.parseBoolean(
                config.get(OPTION, "Affect Mining", true, "Breaking blocks drains stamina, adds mining fatigue")
                        .getString());
        ...
        StaminaBar.levelUp = Boolean.parseBoolean(
                config.get(OTHER, "Level Max Stamina", false, "This makes your experience bar increase max stamina")
                        .getString());
        StaminaBar.levelAmount = Float.parseFloat(
                config.get(OTHER, "Level Up Amount", 5F, "How much an experience level increases stamina max")
                        .getString());
    }
