...
public class ConfigArmour extends ConfigurationBaseMF {
    ...
    protected void loadConfig() {
        resistArrow = Boolean.parseBoolean(
                config.get(
                        CATEGORY_BONUS,
                        "Deflect Arrows",
                        true,
                        ...
                        .getString());
        TacticalManager.arrowDeflectChance = Float.parseFloat(
                config.get(
                        CATEGORY_BONUS,
        ...
        TacticalManager.shouldSlow = Boolean.parseBoolean(
                config.get(
                        CATEGORY_PENALTIES,
                        ...
                        .getString());
        TacticalManager.minWeightSpeed = Float.parseFloat(
                config.get(
                        CATEGORY_PENALTIES,
                        ...
                        .getString());
        ArmourCalculator.slowRate = Float.parseFloat(
                config.get(
                        CATEGORY_PENALTIES,
                        "Slowdown Rate",
                        1.0F,
        ...
        ArmourCalculator.useConfigIndirectDmg = Boolean.parseBoolean(
                config.get(
                        "Misc",
        ...
        cogworkGrief = Boolean.parseBoolean(
                config.get(
                        CATEGORY_COGWORK,
                        "Cogwork Grief",
                        true,
        ...
        cogworkFuelUnits = Float.parseFloat(
                config.get(CATEGORY_COGWORK, "Cogwork Fuel Modifier", 1F, "Modify the amount of fuel added to cogworks")
                        .getString());
        EntityCogwork.health_modifier = Float.parseFloat(
                config.get(
                        CATEGORY_COGWORK,
                        "Cogwork Durability Modifier",
                        1.0F,
                        "Modify the relative durability of cogwork armour").getString());
        EntityCogwork.rating_modifier = Float.parseFloat(
                config.get(
                        CATEGORY_COGWORK,
                        "Cogwork Armour Modifier",
                        1.0F,
                        "Modify the relative armour rating of cogwork armour").getString());
        EntityCogwork.allowedBulk = Integer.parseInt(
                config.get(
                        CATEGORY_COGWORK,
