...
public class KnowledgePageRegistry {
    ...
    public static void registerPages() {
        ...
        if (ConfigHardcore.HCCallowRocks) {
            KnowledgeListMF.gettingStarted.addPages(
        ...
        KnowledgeListMF.gettingStarted.addPages(
                ...
                new EntryPageRecipeAnvil(KnowledgeListMF.shearsR),
                new EntryPageText("knowledge.gettingStarted.4"),
                new EntryPageText("knowledge.gettingStarted.5"),
                new EntryPageRecipeAnvil(KnowledgeListMF.hammerR),
                new EntryPageRecipeAnvil(KnowledgeListMF.tongsR),
        ...
        KnowledgeListMF.gettingStarted.addPages(
                ...
                new EntryPageRecipeCarpenter(KnowledgeListMF.quernR),
                new EntryPageText("knowledge.gettingStarted.11"),
                new EntryPageText("knowledge.gettingStarted.12"));
        KnowledgeListMF.gettingStarted.addPages(
                new EntryPageRecipeCarpenter(KnowledgeListMF.bSalvageR),
                new EntryPageText("knowledge.gettingStarted.13"));

        KnowledgeListMF.research.addPages(
        ...
        KnowledgeListMF.talisman.addPages(new EntryPageText("knowledge.talisman.2"));
        if (!ConfigHardcore.HCCRemoveTalismansCraft) {
        ...
        KnowledgeListMF.combat.addPages(
        ...
        KnowledgeListMF.craftArmourBasic.addPages(
        ...
        KnowledgeListMF.carpenter.addPages(
                new EntryPageText("knowledge.carpenter.1"),
                new EntryPageRecipeBase(KnowledgeListMF.carpenterRecipe));
        KnowledgeListMF.salvage.addPages(
        ...
        KnowledgeListMF.commodities.addPages(
        ...
        KnowledgeListMF.commodities.addPages(
                ...
                new EntryPageRecipeAnvil(KnowledgeListMF.hunkR),
                new EntryPageRecipeAnvil(KnowledgeListMF.ingotR));
        KnowledgeListMF.commodities.addPages(
        ...
        KnowledgeListMF.dust.addPages(
                ...
                new EntryPageGrind(
                        new ItemStack(ComponentListMF.kaolinite),
        ...
        KnowledgeListMF.minotaurs.addPages(
                new EntryPageText("knowledge.minotaurs.1"),
                new EntryPageText("knowledge.minotaurs.2"),
                new EntryPageText("knowledge.minotaurs.3"),
        ...
        KnowledgeListMF.dragons
                .addPages(new EntryPageText("knowledge.dragons.1"), new EntryPageText("knowledge.dragons.2"));
        ...
        KnowledgeListMF.chimney.addPages(
                new EntryPageText("knowledge.chimney.1"),
                new EntryPageRecipeCarpenter(KnowledgeListMF.chimneyRecipe),
        ...
        KnowledgeListMF.tanning.addPages(
        ...
        KnowledgeListMF.bloomery.addPages(
                new EntryPageText("knowledge.bloomery.1"),
                new EntryPageRecipeCarpenter(KnowledgeListMF.bloomeryR),
                new EntryPageText("knowledge.bloomery.2"),
                new EntryPageText("knowledge.bloomery.3"));
        KnowledgeListMF.crucible.addPages(
        ...
        KnowledgeListMF.crucible2.addPages(
        ...
        if (ConfigHardcore.HCCreduceIngots) {
            ...
            KnowledgeListMF.smeltCopper.addPages(
                    new EntryPageRecipeBloom(
                            new ItemStack(BlockListMF.oreCopper),
                            new ItemStack(ComponentListMF.ingots[0])));
            KnowledgeListMF.smeltBronze.addPages(
                    new EntryPageRecipeBloom(
                            new ItemStack(BlockListMF.oreTin),
                            new ItemStack(ComponentListMF.ingots[1])));
        } else {
            KnowledgeListMF.smeltCopper.addPages(
                    new EntryPageSmelting(
                            new ItemStack(BlockListMF.oreCopper),
                            new ItemStack(ComponentListMF.ingots[0])));
            KnowledgeListMF.smeltBronze.addPages(
        ...
        KnowledgeListMF.smeltPig.addPages(
        ...
        KnowledgeListMF.smeltSteel.addPages(
        ...
        KnowledgeListMF.encrusted.addPages(
        ...
        KnowledgeListMF.obsidian.addPages(
        ...
        KnowledgeListMF.anvil.addPages(
        ...
        KnowledgeListMF.craftArmourLight.addPages(
                new EntryPageRecipeCarpenter(KnowledgeListMF.padding[0]),
        ...
        KnowledgeListMF.craftArmourLight.addPages(
                new EntryPageRecipeCarpenter(KnowledgeListMF.reHelmetR),
        ...
        KnowledgeListMF.craftArmourLight.addPages(
                new EntryPageRecipeAnvil(KnowledgeListMF.studHelmetR),
        ...
        KnowledgeListMF.craftArmourMedium.addPages(
        ...
        KnowledgeListMF.craftArmourHeavy.addPages(
        ...
        KnowledgeListMF.coalflux.addPages(
        ...
        KnowledgeListMF.blastfurn
                .addPages(new EntryPageText("knowledge.blastfurn.1"), new EntryPageText("knowledge.blastfurn.2"));
        ...
        KnowledgeListMF.etools.addPages(
                new EntryPageText("knowledge.etools.1"),
                new EntryPageRecipeAnvil(KnowledgeListMF.spannerR),
                new EntryPageRecipeAnvil(KnowledgeListMF.eatoolsR));
        KnowledgeListMF.ecomponents.addPages(
                new EntryPageText("knowledge.ecomponents.1"),
                new EntryPageRecipeAnvil(KnowledgeListMF.boltR),
                new EntryPageText("knowledge.ecomponents.2"),
                new EntryPageRecipeAnvil(KnowledgeListMF.iframeR),
                new EntryPageRecipeAnvil(KnowledgeListMF.bgearR),
                new EntryPageRecipeAnvil(KnowledgeListMF.tgearR),
                new EntryPageRecipeAnvil(KnowledgeListMF.istrutR),
                new EntryPageRecipeAnvil(KnowledgeListMF.stubeR));
        KnowledgeListMF.tungsten.addPages(
        ...
        KnowledgeListMF.blackpowder.addPages(
        ...
        KnowledgeListMF.shrapnel.addPages(
        ...
        KnowledgeListMF.firebomb.addPages(
        ...
        KnowledgeListMF.bombCeramic.addPages(
        ...
        KnowledgeListMF.crossShafts.addPages(
        ...
        KnowledgeListMF.crossHeads.addPages(
        ...
        KnowledgeListMF.cogArmour.addPages(
                ...
                new EntryPageRecipeAnvil(KnowledgeListMF.cogHelmR),
                new EntryPageRecipeAnvil(KnowledgeListMF.cogChestR),
        ...
        KnowledgeListMF.cogArmour.addPages(
                new EntryPageRecipeAnvil(KnowledgeListMF.hugePlateR),
        ...
        KnowledgeListMF.thatch.addPages(
        ...
        KnowledgeListMF.bars
                .addPages(new EntryPageText("knowledge.bars.1"), new EntryPageRecipeAnvil(KnowledgeListMF.barsR));
        KnowledgeListMF.paint_brush.addPages(
        ...
        KnowledgeListMF.decorated_stone.addPages(
        ...
        KnowledgeListMF.bed_roll.addPages(
                new EntryPageText("knowledge.bed_roll.1"),
                new EntryPageRecipeCarpenter(KnowledgeListMF.bedrollR));
        KnowledgeListMF.tool_rack.addPages(
        ...
        KnowledgeListMF.food_box.addPages(
                new EntryPageText("knowledge.food_box.1"),
                new EntryPageRecipeCarpenter(KnowledgeListMF.foodboxR),
                new EntryPageText("knowledge.ammo_box.2"));
        KnowledgeListMF.ammo_box.addPages(
                new EntryPageText("knowledge.ammo_box.1"),
                new EntryPageRecipeCarpenter(KnowledgeListMF.ammoboxR),
                new EntryPageText("knowledge.ammo_box.2"));
        KnowledgeListMF.big_box.addPages(
                new EntryPageText("knowledge.big_box.1"),
                new EntryPageRecipeCarpenter(KnowledgeListMF.bigboxR),
                new EntryPageText("knowledge.ammo_box.2"));
        ...
        KnowledgeListMF.constructionPts.addPages(
                new EntryPageRecipeCarpenter(KnowledgeListMF.jugRecipe),
                new EntryPageSmelting(FoodListMF.jug_uncooked, FoodListMF.jug_empty),
                new EntryPageRecipeBase(KnowledgeListMF.plantOilR),
                new EntryPageRecipeCarpenter(KnowledgeListMF.refinedPlankR));
        ...
        if (ConfigHardcore.HCCallowRocks) {
            KnowledgeListMF.craftHCCTools.addPages(
            ...
            KnowledgeListMF.craftHCCTools.addPages(
                    new EntryPageRecipeCarpenter(KnowledgeListMF.stoneSwordR),
        ...
        KnowledgeListMF.craftAdvTools.addPages(
                new EntryPageText("knowledge.hvypick.info"),
                new EntryPageRecipeAnvil(KnowledgeListMF.hvyPickR));
        KnowledgeListMF.craftAdvTools
                .addPages(new EntryPageText("knowledge.trow.info"), new EntryPageRecipeAnvil(KnowledgeListMF.trowR));
        KnowledgeListMF.craftAdvTools.addPages(
        ...
        KnowledgeListMF.craftAdvTools.addPages(
                ...
                new EntryPageRecipeAnvil(KnowledgeListMF.mattockR),
        ...
        KnowledgeListMF.firemaker.addPages(
        ...
        KnowledgeListMF.craftCrafters.addPages(
                new EntryPageRecipeCarpenter(KnowledgeListMF.stoneHammerR),
                new EntryPageRecipeAnvil(KnowledgeListMF.hammerR),
                new EntryPageText(""));
        KnowledgeListMF.craftCrafters.addPages(
        ...
        KnowledgeListMF.craftCrafters.addPages(
                ...
                new EntryPageRecipeCarpenter(KnowledgeListMF.stoneKnifeR),
                new EntryPageRecipeAnvil(KnowledgeListMF.knifeR),
                new EntryPageText(""));
        KnowledgeListMF.craftCrafters
                .addPages(new EntryPageText("knowledge.saw.info"), new EntryPageRecipeAnvil(KnowledgeListMF.sawsR));
        KnowledgeListMF.craftCrafters.addPages(
                new EntryPageText("knowledge.needle.info"),
                new EntryPageRecipeCarpenter(KnowledgeListMF.boneNeedleR),
                new EntryPageRecipeAnvil(KnowledgeListMF.needleR),
                new EntryPageText(""));
        KnowledgeListMF.craftCrafters.addPages(
        ...
        KnowledgeListMF.craftWeapons
                .addPages(new EntryPageText("knowledge.sword.info"), new EntryPageRecipeAnvil(KnowledgeListMF.swordR));
        KnowledgeListMF.craftWeapons.addPages(
                new EntryPageText("knowledge.waraxe.info"),
                new EntryPageRecipeAnvil(KnowledgeListMF.waraxeR));
        KnowledgeListMF.craftWeapons
                .addPages(new EntryPageText("knowledge.mace.info"), new EntryPageRecipeAnvil(KnowledgeListMF.maceR));
        KnowledgeListMF.craftWeapons
                .addPages(new EntryPageText("knowledge.spear.info"), new EntryPageRecipeAnvil(KnowledgeListMF.spearR));
        KnowledgeListMF.craftWeapons
                .addPages(new EntryPageText("knowledge.bow.info"), new EntryPageRecipeAnvil(KnowledgeListMF.bowR));
        ...
        KnowledgeListMF.craftAdvWeapons.addPages(
        ...
        KnowledgeListMF.craftAdvWeapons
                .addPages(new EntryPageText("knowledge.lance.info"), new EntryPageRecipeAnvil(KnowledgeListMF.lanceR));

        KnowledgeListMF.arrows.addPages(new EntryPageText("knowledge.arrows.1"));
        KnowledgeListMF.arrows.addPages(
                new EntryPageRecipeCarpenter(KnowledgeListMF.fletchingR),
        ...
        KnowledgeListMF.smeltBlackSteel.addPages(
                new EntryPageText("knowledge.smeltBlackSteel.1"),
                new EntryPageRecipeAnvil(KnowledgeListMF.obsidianHunkR),
                new EntryPageCrucible(KnowledgeListMF.black),
                new EntryPageBlastFurnace(ComponentListMF.ingots[6], black));
        KnowledgeListMF.smeltRedSteel.addPages(
                new EntryPageText("knowledge.smeltRedSteel.1"),
                new EntryPageCrucible(KnowledgeListMF.red),
                new EntryPageBlastFurnace(ComponentListMF.ingots[9], red));
        KnowledgeListMF.smeltBlueSteel.addPages(
        ...
        KnowledgeListMF.smeltAdamant.addPages(
                new EntryPageText("knowledge.smeltAdamantium.1"),
                new EntryPageText("knowledge.smeltAdamantium.2"),
                new EntryPageCrucible(KnowledgeListMF.adamantium));
        KnowledgeListMF.smeltMithril.addPages(
                new EntryPageText("knowledge.smeltMithril.1"),
                new EntryPageText("knowledge.smeltMithril.2"),
                new EntryPageCrucible(KnowledgeListMF.mithril));

        KnowledgeListMF.smeltMaster.addPages(
        ...
        KnowledgeListMF.cookingutensil.addPages(
        ...
        KnowledgeListMF.jug.addPages(
                new EntryPageText("knowledge.jug.1"),
                new EntryPageRecipeCarpenter(KnowledgeListMF.jugRecipe),
                new EntryPageSmelting(FoodListMF.jug_uncooked, FoodListMF.jug_empty),
                new EntryPageText("knowledge.jug.2"),
                new EntryPageRecipeBase(KnowledgeListMF.waterJugR),
                new EntryPageRecipeBase(KnowledgeListMF.milkJugR));

        KnowledgeListMF.generic_meat.addPages(
        ...
        KnowledgeListMF.saussage.addPages(
                ...
                new EntryPageRecipeCarpenter(KnowledgeListMF.saussageR),
                new EntryPageSmelting(
                        new ItemStack(FoodListMF.saussage_raw),
                        new ItemStack(FoodListMF.saussage_cooked)));
        KnowledgeListMF.sandwitch.addPages(
        ...
        KnowledgeListMF.sandwitchBig.addPages(
                new EntryPageText("knowledge.sandwitchBig.1"),
                new EntryPageRecipeCarpenter(KnowledgeListMF.sandwitchBigRecipe));
        KnowledgeListMF.meatpie.addPages(
        ...
        KnowledgeListMF.shepardpie.addPages(
        ...
        KnowledgeListMF.bread.addPages(
        ...
        KnowledgeListMF.bread.addPages(
                new EntryPageRecipeCarpenter(KnowledgeListMF.simpCakeR),
                new EntryPageSmelting(
        ...
        KnowledgeListMF.carrotcake.addPages(
        ...
        KnowledgeListMF.chococake.addPages(
        ...
        KnowledgeListMF.bfcake.addPages(
        ...
        KnowledgeListMF.berrypie.addPages(
        ...
        KnowledgeListMF.applepie.addPages(
        ...
        KnowledgeListMF.eclair.addPages(
        ...
        KnowledgeListMF.cheese.addPages(
        ...
        KnowledgeListMF.bandageadv.addPages(
        ...
        KnowledgeListMF.counteratt
                .addPages(new EntryPageText("knowledge.counteratt.1"), new EntryPageText("knowledge.counteratt.2"));
    ...
    private static EntryPage[] assembleOreDesc(String orename, Block ore, Item ingot) {
        return new EntryPage[] { new EntryPageImage(
                "textures/gui/knowledge/image/" + orename + ".png",
                96,
                96,
    ...
    private static EntryPage[] assembleImgPage(String name, Block blockname) {
        return new EntryPage[] { new EntryPageImage(
                "textures/gui/knowledge/image/" + name + ".png",
                96,
                96,
                "knowledge." + name + ".1") };
    }
    ...
    private static EntryPage[] assembleMobDesc(String name) {
        return new EntryPage[] { new EntryPageImage(
                "textures/gui/knowledge/image/mob/" + name + ".png",
                96,
                96,
                "knowledge." + name + ".1") };
    }
