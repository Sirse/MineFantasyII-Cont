...
public class EntryPageRecipeBloom extends EntryPage {
    ...
    public void render(GuiScreen parent, int x, int y, float f, int posX, int posY, boolean onTick) {
        ...
        this.mc.getTextureManager().bindTexture(TextureHelperMF.getResource("textures/gui/knowledge/bloomeryGrid.png"));
        parent.drawTexturedModalRect(posX, posY, 0, 0, this.universalBookImageWidth, this.universalBookImageHeight);

        String cft = "<" + StatCollector.translateToLocal("method.bloomery") + ">";
