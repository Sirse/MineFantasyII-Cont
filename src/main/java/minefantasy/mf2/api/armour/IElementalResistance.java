...
public interface IElementalResistance {
    ...
    /**
     * @return this determines the chance an item is to deflect arrows. more damage means less chance
     */
    public float getArrowDeflection(ItemStack item, DamageSource source);

    /**
     * @return the Magic resistance percent (0-100) (for the whole suit) -values mean weakness
     */
    ...
    /**
     * @return the Base resistance percent for non magic/fire(0-100) (for the whole suit) -values mean weakness
     */
