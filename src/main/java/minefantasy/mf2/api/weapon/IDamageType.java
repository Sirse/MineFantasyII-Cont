...
public interface IDamageType {
     ...
     *
     * @param implement the object causing the damage, this is "ItemStack" for items and "Entity" for projectiles This
     *                  can therefore be implemented by projectile entities and items
     */
