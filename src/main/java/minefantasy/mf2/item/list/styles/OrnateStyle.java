...
public class OrnateStyle {
    ...
    public static void load() {
        ...
        ornate_chain_helmet = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "chain_helmet",
        ...
        ornate_chain_chest = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "chain_chest",
                ArmourDesign.CHAINMAIL,
                1,
                "chain_layer_1",
                0).modifyRating(ratingMod).setCreativeTab(tab);
        ornate_chain_legs = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "chain_legs",
                ArmourDesign.CHAINMAIL,
                2,
                "chain_layer_2",
                0).modifyRating(ratingMod).setCreativeTab(tab);
        ornate_chain_boots = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "chain_boots",
                ArmourDesign.CHAINMAIL,
                3,
        ...
        ornate_scale_helmet = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "scale_helmet",
                ...
                "scale_layer_1",
                0).modifyRating(ratingMod).setCreativeTab(tab);
        ornate_scale_chest = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "scale_chest",
                ArmourDesign.SCALEMAIL,
                1,
                "scale_layer_1",
                0).modifyRating(ratingMod).setCreativeTab(tab);
        ornate_scale_legs = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "scale_legs",
                ArmourDesign.SCALEMAIL,
                2,
                "scale_layer_2",
                0).modifyRating(ratingMod).setCreativeTab(tab);
        ornate_scale_boots = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "scale_boots",
                ArmourDesign.SCALEMAIL,
                3,
        ...
        ornate_splint_helmet = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "splint_helmet",
                ...
                "splint_layer_1",
                0).modifyRating(ratingMod).setCreativeTab(tab);
        ornate_splint_chest = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "splint_chest",
                ArmourDesign.SPLINTMAIL,
                1,
                "splint_layer_1",
                0).modifyRating(ratingMod).setCreativeTab(tab);
        ornate_splint_legs = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "splint_legs",
                ArmourDesign.SPLINTMAIL,
                2,
                "splint_layer_2",
                0).modifyRating(ratingMod).setCreativeTab(tab);
        ornate_splint_boots = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "splint_boots",
                ArmourDesign.SPLINTMAIL,
                3,
        ...
        ornate_plate_helmet = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "plate_helmet",
                ...
                "plate_layer_1",
                0).modifyRating(ratingMod).setCreativeTab(tab);
        ornate_plate_chest = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "plate_chest",
                ArmourDesign.FIELDPLATE,
                1,
                "plate_layer_1",
                0).modifyRating(ratingMod).setCreativeTab(tab);
        ornate_plate_legs = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "plate_legs",
                ArmourDesign.FIELDPLATE,
                2,
                "plate_layer_2",
                0).modifyRating(ratingMod).setCreativeTab(tab);
        ornate_plate_boots = (ItemCustomArmour) new ItemCustomArmour(
                design,
                "plate_boots",
                ArmourDesign.FIELDPLATE,
                3,
