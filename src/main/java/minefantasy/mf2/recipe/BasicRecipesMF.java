...
public class BasicRecipesMF {
    ...
    public static void init() {
        ...
        KnowledgeListMF.stickRecipe = GameRegistry
                .addShapedRecipe(new ItemStack(Items.stick, 2), new Object[] { "S", 'S', ComponentListMF.plank });
        GameRegistry
                .addShapedRecipe(new ItemStack(Items.stick, 2), new Object[] { "S", 'S', ComponentListMF.plank_cut });

        KnowledgeListMF.firepitRecipe = GameRegistry.addShapedRecipe(
                new ItemStack(BlockListMF.firepit),
                new Object[] { " P ", "S S", 'S', Items.stick, 'P', ComponentListMF.plank });
        KnowledgeListMF.cooktopRecipe = GameRegistry.addShapedRecipe(
                new ItemStack(BlockListMF.roast),
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(BlockListMF.ironbark_planks, 4),
                new Object[] { BlockListMF.log_ironbark });
        GameRegistry
                .addShapelessRecipe(new ItemStack(BlockListMF.ebony_planks, 4), new Object[] { BlockListMF.log_ebony });
        ...
        KnowledgeListMF.plantOilR = GameRegistry.addShapedRecipe(
                new ItemStack(ComponentListMF.plant_oil, 4),
                new Object[] { " B ", "BFB", " B ", 'F', Items.wheat_seeds, 'B', FoodListMF.jug_empty });
        KnowledgeListMF.waterJugR = GameRegistry.addShapedRecipe(
                new ItemStack(FoodListMF.jug_water, 4),
                new Object[] { " B ", "BWB", " B ", 'W', Items.water_bucket, 'B', FoodListMF.jug_empty });
        KnowledgeListMF.sugarRecipe = GameRegistry.addShapedRecipe(
                new ItemStack(FoodListMF.sugarpot),
        ...
        KnowledgeListMF.milkJugR = GameRegistry.addShapedRecipe(
                new ItemStack(FoodListMF.jug_milk, 4),
        ...
        GameRegistry.addShapelessRecipe(
                new ItemStack(ComponentListMF.hideSmall),
                new Object[] { ComponentListMF.rawhideSmall, ComponentListMF.flux });
        GameRegistry.addShapelessRecipe(
                new ItemStack(ComponentListMF.hideMedium),
        ...
        KnowledgeListMF.dryrocksR = GameRegistry
                .addShapedRecipe(new ItemStack(ToolListMF.dryrocks), new Object[] { "R ", " R", 'R', rock });
    ...
    private static void addFoodOutput() {
        KnowledgeListMF.cheeseOut = GameRegistry.addShapedRecipe(
                new ItemStack(BlockListMF.cheese_wheel),
                new Object[] { "F", 'F', FoodListMF.cheese_pot, });
        KnowledgeListMF.meatpieOut = GameRegistry.addShapedRecipe(
                new ItemStack(BlockListMF.pie_meat),
                new Object[] { "F", 'F', FoodListMF.pie_meat_cooked });
        KnowledgeListMF.shepardOut = GameRegistry.addShapedRecipe(
                new ItemStack(BlockListMF.pie_shepards),
                new Object[] { "F", 'F', FoodListMF.pie_shepard_cooked });
        KnowledgeListMF.appleOut = GameRegistry.addShapedRecipe(
                new ItemStack(BlockListMF.pie_apple),
                new Object[] { "F", 'F', FoodListMF.pie_apple_cooked });
        KnowledgeListMF.berryOut = GameRegistry.addShapedRecipe(
                new ItemStack(BlockListMF.pie_berry),
