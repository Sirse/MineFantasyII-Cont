...
public interface IOffhandDual {
    ...
    /**
     * Perform any function when the item is held in the offhand and the user right clicks an entity. This is generally
     * used to attack an entity with the offhand item. If this is the case the event should be canceled to prevent any
     * default right clicking events (Eg Villager Trading)
     *
    ...
    /**
     * Perform any function when the item is held in the offhand and the user right clicks a block. Note that this will
     * happen prior to the activation of any activation functions of blocks
     *
     * @param event        the PlayerInteractEvent that was generated
     * @param mainhandItem the ItemStack currently being held in the right hand
     * @param offhandItem  the ItemStack currently being held in the left hand
